...
def VisualizePegs(pegList, stepNumber=0, lastAction=None, pegColor1='#0000ff', pegColor2='#ff0000', noPegColor='#000000', nodeSize=120, movedSize=300):
    """
...
def GenerateVideo(stepNumber, name):
    ...
    for filename in range(stepNumber + 1):
        img = cv2.imread('./project2/images/' + str(filename) + '.png')
